...
from utils import encode, decode, get_batch, estimate_loss
...
if __name__ == "__main__":
    ...
    context = torch.tensor([[char2idx['H']]], dtype=torch.long, device=device)
    generated_ids = loaded_model.generate(context, max_new_tokens=500)[0].tolist()
    print(decode(generated_ids, idx2char))
